...
答：围绕“普通断路器主要保护导线和设备免受过电流损害”建立判断框架，能说明它和“人体触电电流可能不足以让普通断路器快速跳闸”的关系，并把断路器（circuit breaker）、过电流（overcurrent）、短路（short circuit）对应到现场设备、导线、端子、图纸或仪表读数。
