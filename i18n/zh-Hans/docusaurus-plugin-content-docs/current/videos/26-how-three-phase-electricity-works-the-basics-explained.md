...
## Why：为什么要学这一集
这一集围绕 **三相电如何工作（Three Phase Electricity）** 展开。学习目标是：围绕“三相电由三个相位相隔约 120 度的交流电组成”建立判断框架，能说明它和“三相系统适合高效率输电和驱动大功率电机”的关系，并把三相电（three phase）、线电压（line voltage）、相电压（phase voltage）对应到现场设备、导线、端子、图纸或仪表读数。

它值得学习，不只是因为它是一个单独知识点，而是因为它会影响后面看图、接线、排故、选仪表和判断风险的方式。在《三相电如何工作（Three Phase Electricity）》这一页，先把“三相电由三个相位相隔约 120 度的交流电组成”对应到三相电（three phase）、线电压（line voltage）、相电压（phase voltage）、平衡负载（balanced load）和现场测量点，再判断正常路径、异常路径和保护装置；作为进阶方向学习，适合商业、工业、HVAC、泵和电机控制；三相和 VFD 风险更高，初学者不应独立操作。
...
## 现场怎么用
- 在《三相电如何工作（Three Phase Electricity）》这一页，先把“三相电由三个相位相隔约 120 度的交流电组成”对应到三相电（three phase）、线电压（line voltage）、相电压（phase voltage）、平衡负载（balanced load）和现场测量点，再判断正常路径、异常路径和保护装置。
...
答：在《三相电如何工作（Three Phase Electricity）》这一页，先把“三相电由三个相位相隔约 120 度的交流电组成”对应到三相电（three phase）、线电压（line voltage）、相电压（phase voltage）、平衡负载（balanced load）和现场测量点，再判断正常路径、异常路径和保护装置。
